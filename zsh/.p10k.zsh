# Generated by Powerlevel10k configuration wizard on 2021-06-21 at 13:44 EDT.
...
() {
  ...
  # Default background color.
	#DAVID
  typeset -g POWERLEVEL9K_BACKGROUND=249
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=232
  # Red prompt symbol if the last command failed.
	#DAVID
  #typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=232
...
#background 249
    ...
    if (( $1 )); then
      ...
      local       meta='%016F'  # grey foreground
      local      clean='%016F'   # green foreground
      local   modified='%016F'  # yellow foreground
      local  untracked='%016F'   # blue foreground
      local conflicted='%016F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%237F'  # grey foreground
      local      clean='%237F'  # grey foreground
      local   modified='%237F'  # grey foreground
      local  untracked='%237F'  # grey foreground
      local conflicted='%237F'  # grey foreground
    fi
